...
export const GET = async (
  ...
  try {
    ...
    const feedUrl = `${appUrl}/api/feed/${login}/json`;
    ...
    void prisma.pageView
      .upsert({
        where: { type_slug_date: { type: "feed_json", slug: login, date: (() => { const d = new Date(); d.setUTCHours(0, 0, 0, 0); return d; })() } },
        create: { type: "feed_json", slug: login, date: (() => { const d = new Date(); d.setUTCHours(0, 0, 0, 0); return d; })(), count: 1 },
    ...
    logError("api/feed/[login]/json GET", err);
