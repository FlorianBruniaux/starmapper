...
# and PgBouncer rejects PGOPTIONS startup params (statement_timeout, tcp_keepalives_*).
# Direct URL: strip -pooler from hostname + remove pgbouncer/connect_timeout params.
NEON_URL=$(python3 -c "
